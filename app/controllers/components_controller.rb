class ComponentsController < ApplicationController
  ...
  def create_gif
    Component.create(content: params[:selectedGifUrl], author: params[:author], to_prompt: ActiveRecord::Type::Boolean.new.type_cast_from_database(params[:to_prompt]), prompt_id: params[:component][:prompt_id], category: "gif")
